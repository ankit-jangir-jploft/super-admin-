...
const Page = () => {
  ...
  const sellerGetId = sellerId.get("id");
  ...
  const fetchSellerList = async () => {
    try {
      const response = await GET(`${BASE_URL}/api/admin/sellerList?id=${sellerGetId}`);
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await POST(`${BASE_URL}/api/admin/sellerUpdate?id=${sellerGetId}`, formData);
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <Form.Group className="mb-3">
                          ...
                          <Form.Select {...register("userType")} defaultValue="Seller">
                      ...
                      <div className="col-md-6">
                        <Form.Group className="mb-3">
                          ...
                          <Form.Select {...register("status")} defaultValue="Active">
                      ...
                      <div className="col-md-6">
                        <Form.Group className="mb-3">
                          ...
                          <Form.Select {...register("language")} defaultValue="1">
